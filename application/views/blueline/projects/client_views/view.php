            ...
            <div class="table-head"><?=$this->lang->line('application_project_details');?></div>
                ...
                <div class="subcont">
                  <ul class="details col-xs-12 col-sm-12 col-md-6">
                    ...
                    <li><span><?=$this->lang->line('application_client');?>:</span> <?php if(!is_object($project->company)){ ?> <a href="#" class="label label-default"><?php echo $this->lang->line('application_no_client_assigned'); }else{ ?><a class="label label-success" href="#"><?php echo $project->company->name;} ?></a></li>
  ...
  <div class="row tab-pane fade" role="tabpanel" id="tasks-tab">
     <div class="col-xs-12 col-sm-12  task-container-left">
            ...
            <li id="task_<?=$value->id;?>" class="<?=$value->status;?> priority<?=$value->priority;?> list-item">
              ...
              <input name="form-field-checkbox" class="checkbox-nolabel task-check dynamic-reload" data-reload="tile-pie" type="checkbox" data-link="<?=base_url()?>cprojects/tasks/<?=$project->id;?>/check/<?=$value->id;?>" <?php if($value->status == "done"){echo "checked";}?> <?=$disable?>/>
                        ...
                        <ul class="details">
                            ...
                            <?php } ?>
                              <li>
                                  ...
                                  <?php if($value->user_id != 0 && $value->user_id != ""){ echo $value->user->firstname." ".$value->user->lastname;}else{echo $this->lang->line('application_not_assigned');}?> 
                              </li>
                              <li>
                              ...
                              <div class="form-group filled chat_message_input">
                                ...
                                <ul class="task-comments">
                                    ...
                                    foreach($value->task_has_comments as $comments){ 
                                        if(!empty($comments->attachment)){ $mime = explode("/", get_mime_by_extension($comments->attachment)); }
                                      ?>
                                        <li>
...
<div class="table-div">
 <table class="data table" id="cinvoices" rel="<?=base_url()?>" cellspacing="0" cellpadding="0">
    ...
    <tr id="<?=$value->id;?>" >
      ...
      <td onclick=""><span class="label label-info"><?php if(is_object($value->company)){echo $value->company->name; }?></span></td>
