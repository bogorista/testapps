...
<div class="top-background">
   <table width="100%" cellspacing="0" >
        ...
        <tr>
            ...
            <td class="right" style="vertical-align:top"><strong><?php if(is_object($invoice->company->client)){ ?> <?=$invoice->company->client->firstname;?> <?=$invoice->company->client->lastname;?></strong><?php } ?></td>
        </tr>
        <tr>
