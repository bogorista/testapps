	 ...
	 <div class="col-xs-12 col-md-9">
	        ...
	        <div class="article-content">
			  ...
			  <div class="article-content">
			 		...
			 		<div class="article-title"><?=$value->subject;?> <?php if($value->internal == "0"){ ?><i class="icon dripicons-preview tt pull-right" title="<?=$this->lang->line('application_task_public');?>"> </i> <?php } ?>
		</div>
